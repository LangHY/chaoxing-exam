...
- ✅ 超星学习通**章节测试**（本章单元测试）
- ✅ 超星学习通**随堂测验**、课堂小测等非正式考试
- ✅ 任何通过 `mooc1.chaoxing.com` / `mooc2-ans.chaoxing.com` 访问的在线答题页面
- ✅ 题目含**数学公式图片**（物理、高数、线代等）
- ✅ 支持**单选题、多选题、判断题、填空题**
- ✅ 支持**自动重做**（提交后检查错题，用标准答案重做拿满分）
- ⚠️ 简答题/论述题支持填写，但答案质量取决于主 Agent 能力
- ❌ 正式考试（有监考、防切屏等机制）不适用
- ❌ 不支持视频题、实操题、上传文件题
